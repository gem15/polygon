...
CREATE TABLE RESPONSE_EXTRA -- not used
   (	ID NUMBER(10,0) NOT NULL, 
	MASTER VARCHAR2(3000) NOT NULL, 
	ALIAS_TEXT VARCHAR2(255) NOT NULL, 
	VOC VARCHAR2(255) NOT NULL, 
...
CREATE TABLE KB_SOST
   (	ID INT default seq.nextval,--VARCHAR2(38),
	FK_ID VARCHAR2(38), 
	ID_OBSL VARCHAR2(38), 
	ID_SOST VARCHAR2(38), 
	ID_TIR VARCHAR2(38), 
...
/* CREATE TABLE KB_ZAK
   (	ID VARCHAR2(38),
	...
	N_ZAK VARCHAR2(256),
	NAIMEN VARCHAR2(256),
	ID_STRANA VARCHAR2(38) DEFAULT NULL,
	P_IND NUMBER(6,0),
	UR_ADR VARCHAR2(300),
	FIO VARCHAR2(100),
	TLF VARCHAR2(60),
	...
	DT_END DATE,
	KPP_ZAK NUMBER(9,0),
	ROW_CREATOR VARCHAR2(30) DEFAULT NULL,
